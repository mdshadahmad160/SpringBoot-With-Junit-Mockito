...
public class PokemonServiceTests {
    ...
    public void PokemonService_GetAllPokemon_ReturnResponseDto() {
        ...
        PokemonResponse response = pokemonService.getAllPokemon(1, 10);
        Assertions.assertThat(response).isNotNull();
    }

    @Test
    public void PokemonService_FindById_ReturnsPokemonDto() {
        int pokemonId = 1;
        Pokemon pokemon = Pokemon.builder()
                .id(1)
                .name("pikachu")
    ...
    public void PokemonService_UpdatePokemon_ReturnPokemonDto() {
        ...
        PokemonDto updatedPokemonReturn = pokemonService.updatePokemon(pokemonDto, pokemonId);
        Assertions.assertThat(updatedPokemonReturn).isNotNull();
